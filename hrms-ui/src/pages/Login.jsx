...
export default function Login() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setErrors({ general: "Server not reachable. Please try again later." });
    } finally {
      setLoading(false);
    }
  };
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-200 via-slate-300/80 to-slate-400/60 flex flex-col">
      {/* HEADER */}
      <header className="flex items-center px-10 py-4">
        <img src={logo} className="w-9 h-9 mr-3" />
      ...
      <main className="flex-1 flex items-center justify-center px-6">
        <div className="w-full max-w-6xl max-h-[85vh] grid grid-cols-1 md:grid-cols-2 rounded-3xl bg-white/30 backdrop-blur-2xl border border-white/40 shadow-[0_40px_120px_rgba(0,0,0,0.25)] overflow-hidden">
          {/* LEFT */}
          <div className="bg-gradient-to-br from-teal-600/90 to-cyan-600/90 text-white px-12 py-8 flex flex-col justify-center">
          ...
          <div className="px-6 py-4 flex flex-col justify-center">
            <div className="text-center mb-4">
              <img src={logo} className="w-12 mx-auto mb-2" />
            ...
            <div className="flex justify-center mb-4">
              <div className="flex rounded-xl bg-white/40 backdrop-blur-xl border border-white/50 p-1 shadow-inner">
                {roles.map((r) => (
                  <button
                    key={r.name}
            ...
            <div className="grid grid-cols-2 gap-3 mb-4">
              <button className="flex items-center justify-center gap-2 py-2 rounded-lg bg-white/40 backdrop-blur border border-white/50 hover:bg-white/60 transition">
            ...
            <form onSubmit={handleSubmit} className="space-y-3">
              <div>
                ...
                <input
                  ...
                  className={`w-full mt-1 px-4 py-2.5 rounded-xl bg-white/40 backdrop-blur-xl border border-white/50 focus:outline-none focus:ring-2 ${theme.ring}`}
                />
              </div>
              ...
              <button
                type="submit"
                className={`w-full py-2.5 rounded-xl font-semibold text-white bg-gradient-to-r ${theme.btn} shadow-lg hover:scale-[1.02] transition`}
              >
      ...
      {forgotOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center">
          ...
          />
          <div className="relative bg-white/70 backdrop-blur-xl border border-white/50 rounded-2xl p-6 w-96 shadow-xl">
            <button
              onClick={() => setForgotOpen(false)}
            ...
            <input className="w-full px-4 py-2 rounded-lg bg-white/60 border border-white/50 mb-4" />
